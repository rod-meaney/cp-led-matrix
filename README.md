...
#### Other features
* I switched out the initial weather API I was using, and I find the current one much more stable (in Text Display). Its dependant on finding your city so could have issues if you have a common city name. LOTS of scope to do stuff here.  
